...
window.VlocityDiagnosticWizard_StepTemplates = {
  ...
  getNewCpqConfigurationSetupStep: function () {
    ...
    const recordOptions = {
      SObject: {
        SObjectType: "vlocity_cmt__CpqConfigurationSetup",
        Name: "REPLACE_ME",
        vlocity_cmt__SetupValue: "REPLACE_ME"
      }
    };
  ...
  getNewCpqConfigurationSetupCustomInputStep: function () {
    ...
    const recordOptions = {
      SObject: {
        SObjectType: "vlocity_cmt__CpqConfigurationSetup",
        Name: "REPLACE_ME",
        vlocity_cmt__SetupValue: "__CUSTOMINPUT__"
      }
    };
  ...
  getNewTriggerSetupStep: function () {
    ...
    const recordOptions = {
      SObject: {
        SObjectType: "vlocity_cmt__TriggerSetup",
        Name: "REPLACE_ME",
        vlocity_cmt__IsTriggerOn: true
      }
    };
  ...
  getNewOmniScriptPicklistValuesStep: function () {
    ...
    const recordOptions = {
      ToolingAPI: {
        ...
        ObjectName: "vlocity_cmt__Element__c",
        FieldName: "vlocity_cmt__Type__c",
