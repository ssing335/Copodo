...
import { OMNIDEF } from './toggelSummaryEnglish_def.js';
import tmpl from './toggelSummaryEnglish.html';
import tmpl_nds from './toggelSummaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class toggelSummaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
