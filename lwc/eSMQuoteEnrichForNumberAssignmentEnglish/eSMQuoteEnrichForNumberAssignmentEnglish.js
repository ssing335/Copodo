...
import { OMNIDEF } from './eSMQuoteEnrichForNumberAssignmentEnglish_def.js';
import tmpl from './eSMQuoteEnrichForNumberAssignmentEnglish.html';
import tmpl_nds from './eSMQuoteEnrichForNumberAssignmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMQuoteEnrichForNumberAssignmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
