...
import { OMNIDEF } from './teamScheduleTcEnglish_def.js';
import tmpl from './teamScheduleTcEnglish.html';
import tmpl_nds from './teamScheduleTcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamScheduleTcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
