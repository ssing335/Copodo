...
import { OMNIDEF } from './demoOpenMasterQuoteEnglish_def.js';
import tmpl from './demoOpenMasterQuoteEnglish.html';
import tmpl_nds from './demoOpenMasterQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoOpenMasterQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
