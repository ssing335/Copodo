...
import { OMNIDEF } from './teamCheckEquipmentConnectionEnglish_def.js';
import tmpl from './teamCheckEquipmentConnectionEnglish.html';
import tmpl_nds from './teamCheckEquipmentConnectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamCheckEquipmentConnectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
