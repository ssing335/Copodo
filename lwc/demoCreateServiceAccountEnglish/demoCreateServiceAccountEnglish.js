...
import { OMNIDEF } from './demoCreateServiceAccountEnglish_def.js';
import tmpl from './demoCreateServiceAccountEnglish.html';
import tmpl_nds from './demoCreateServiceAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoCreateServiceAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
