...
import { OMNIDEF } from './teamRebootModemEnglish_def.js';
import tmpl from './teamRebootModemEnglish.html';
import tmpl_nds from './teamRebootModemEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamRebootModemEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
