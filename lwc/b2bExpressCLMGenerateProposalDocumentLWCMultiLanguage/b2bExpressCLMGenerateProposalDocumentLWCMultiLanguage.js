...
import { OMNIDEF } from './b2bExpressCLMGenerateProposalDocumentLWCMultiLanguage_def.js';
import tmpl from './b2bExpressCLMGenerateProposalDocumentLWCMultiLanguage.html';
import tmpl_nds from './b2bExpressCLMGenerateProposalDocumentLWCMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class b2bExpressCLMGenerateProposalDocumentLWCMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
