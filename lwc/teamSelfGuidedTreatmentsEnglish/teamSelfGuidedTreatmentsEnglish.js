...
import { OMNIDEF } from './teamSelfGuidedTreatmentsEnglish_def.js';
import tmpl from './teamSelfGuidedTreatmentsEnglish.html';
import tmpl_nds from './teamSelfGuidedTreatmentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamSelfGuidedTreatmentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
