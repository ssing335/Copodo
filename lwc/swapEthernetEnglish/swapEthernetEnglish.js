...
import { OMNIDEF } from './swapEthernetEnglish_def.js';
import tmpl from './swapEthernetEnglish.html';
import tmpl_nds from './swapEthernetEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class swapEthernetEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
