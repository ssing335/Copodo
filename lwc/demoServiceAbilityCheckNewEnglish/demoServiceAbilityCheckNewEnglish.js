...
import { OMNIDEF } from './demoServiceAbilityCheckNewEnglish_def.js';
import tmpl from './demoServiceAbilityCheckNewEnglish.html';
import tmpl_nds from './demoServiceAbilityCheckNewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoServiceAbilityCheckNewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
