...
import { OMNIDEF } from './teamTechnicalScheduleEnglish_def.js';
import tmpl from './teamTechnicalScheduleEnglish.html';
import tmpl_nds from './teamTechnicalScheduleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamTechnicalScheduleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
