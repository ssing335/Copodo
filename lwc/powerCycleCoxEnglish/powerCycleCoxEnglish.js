...
import { OMNIDEF } from './powerCycleCoxEnglish_def.js';
import tmpl from './powerCycleCoxEnglish.html';
import tmpl_nds from './powerCycleCoxEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class powerCycleCoxEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
