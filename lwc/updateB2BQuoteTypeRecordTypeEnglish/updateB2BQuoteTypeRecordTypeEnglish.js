...
import { OMNIDEF } from './updateB2BQuoteTypeRecordTypeEnglish_def.js';
import tmpl from './updateB2BQuoteTypeRecordTypeEnglish.html';
import tmpl_nds from './updateB2BQuoteTypeRecordTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class updateB2BQuoteTypeRecordTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
