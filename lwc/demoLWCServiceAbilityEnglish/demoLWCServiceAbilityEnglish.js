...
import { OMNIDEF } from './demoLWCServiceAbilityEnglish_def.js';
import tmpl from './demoLWCServiceAbilityEnglish.html';
import tmpl_nds from './demoLWCServiceAbilityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoLWCServiceAbilityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
