...
import { OMNIDEF } from './coxSystemGuidedFlowEnglish_def.js';
import tmpl from './coxSystemGuidedFlowEnglish.html';
import tmpl_nds from './coxSystemGuidedFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class coxSystemGuidedFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
