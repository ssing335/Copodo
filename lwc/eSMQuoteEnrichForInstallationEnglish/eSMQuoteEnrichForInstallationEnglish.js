...
import { OMNIDEF } from './eSMQuoteEnrichForInstallationEnglish_def.js';
import tmpl from './eSMQuoteEnrichForInstallationEnglish.html';
import tmpl_nds from './eSMQuoteEnrichForInstallationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMQuoteEnrichForInstallationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
