...
import { OMNIDEF } from './eSMQuoteEnrichForAllEnglish_def.js';
import tmpl from './eSMQuoteEnrichForAllEnglish.html';
import tmpl_nds from './eSMQuoteEnrichForAllEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMQuoteEnrichForAllEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
