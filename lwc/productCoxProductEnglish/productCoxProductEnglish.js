...
import { OMNIDEF } from './productCoxProductEnglish_def.js';
import tmpl from './productCoxProductEnglish.html';
import tmpl_nds from './productCoxProductEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class productCoxProductEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
