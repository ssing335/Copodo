...
import { OMNIDEF } from './eSMQuoteEnrichForPaymentEnglish_def.js';
import tmpl from './eSMQuoteEnrichForPaymentEnglish.html';
import tmpl_nds from './eSMQuoteEnrichForPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMQuoteEnrichForPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
