...
import { OMNIDEF } from './b2bExpressCreateQuoteMultiLanguage_def.js';
import tmpl from './b2bExpressCreateQuoteMultiLanguage.html';
import tmpl_nds from './b2bExpressCreateQuoteMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class b2bExpressCreateQuoteMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
