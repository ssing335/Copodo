...
import { OMNIDEF } from './demoServiceAbilityCheckEnglish_def.js';
import tmpl from './demoServiceAbilityCheckEnglish.html';
import tmpl_nds from './demoServiceAbilityCheckEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoServiceAbilityCheckEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
